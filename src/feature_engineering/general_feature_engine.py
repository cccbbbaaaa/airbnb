...
charts_dir = charts_model_dir  # 特征工程通常与模型相关 / Feature engineering usually relates to models
...
listings['license'] = listings['license'].notna()  # True表示有license，False表示没有license
